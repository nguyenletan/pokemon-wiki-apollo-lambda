...
const resolvers = {
  Query: {
    ...
    getPokemon: async (_, { id }, { dataSources }) =>
      dataSources.Pokemon.getPokemon(id),

    getType: async (_, { name }, { dataSources }) =>
      dataSources.Pokemon.getType(name),

    getPokemons: async (_, { limit, offset }, { dataSources }) =>
      dataSources.Pokemon.getPokemons(limit, offset),

    getPokemonFromHub: async (_, { name }, { dataSources }) =>
      dataSources.PokemonHub.getPokemonByName(name),

    getPokemonById: async (_, { id, form }, { dataSources }) =>
      dataSources.PokemonHub.getPokemonById(id, form),

    getMoveSets: async (_, { id }, { dataSources }) =>
      dataSources.PokemonHub.getMoveSets(id)
  }
};
